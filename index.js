    ...
    // Or create a new window
      ...
      gui.Window.open(getTemplatePath(), config.defaultWindow, function (newWindow) {
        ...
        notificationWindow.on('loaded', function () {
          ...
          // Size and radius
          var style = {
            height: config.height - 2 * config.borderRadius - 2 * config.defaultStyleContainer.padding - 2,
            width: config.width - 2 * config.borderRadius - 2 * config.defaultStyleContainer.padding - 2,
